...
//       dir          sub-directory location of reduced slugfile to be averaged
//       reduced_dir  sub-directory location of raw reduced slugfile 
///////////////////////////////////////////////////////////////////////////////
...
Int_t MakeRunletAverages(Int_t slug, TString type = "reduced", 
			 ...
			 TString dir = "/net/data2/paschkelab1/pass5c_reduced_slugfiles" ,
			 TString reduced_dir = "/net/data2/paschkelab1/pass5c_reduced_slugfiles" ) 
{
  bool debug = 0, add_composite_leaves = 0;
  int run_period = (slug<137 ? 1 : 2);
  TString dirname = Form("%s/run%i",   dir.Data(), run_period);
  //If not averaging raw reduced file use dirname_1 to specify where to find 
  //raw reduced slugfile in case it is not in same location.
  TString dirname_1 = Form("%s/run%i", reduced_dir.Data(), run_period);
